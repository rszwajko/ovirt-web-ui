...
export const messages: { [messageId: string]: MessageType } = {
  ...
  allVirtualMachines: 'All virtual machines',
  ...
  automaticConsoleConnection: 'Automatic console connection',
  automaticConsoleConnectionDetails: 'Automatically connect to the console when the VM is running',
  bootMenu: 'Boot Menu',
  ...
  confirmationMessages: 'Confirmation messages',
  confirmChanges: 'Confirm changes',
  confirmDelete: 'Confirm Delete',
  confirmDeletingVm: 'Confirm deleting a virtual machine',
  confirmDeletingVmDetails: 'Require confirmation before deleting a virtual machine',
  confirmForceShutdowns: 'Confirm force shutdowns',
  confirmForceShutdownsDetails: 'Require confirmation before a force shutdown',
  ...
  ctrlAltDelTooltip: 'Maps Ctrl+Alt+Del to Ctrl+Alt+End.',
  ...
  disableVmNotifications: 'Disable virtual machine notifications',
  ...
  displayUnsavedChangesWarnings: 'Display unsaved changes warnings',
  displayUnsavedChangesWarningsDetail: 'Display warnings messages for unsaved changes',
  ...
  globalSettingsWillBeApplied: 'The settings options featured here will be applied globally across all VMs.',
  goBack: 'Go Back',
  ...
  resettingAccountSettingsWillClearSettings: 'Resetting your account settings will clear all of the individual settings that were applied to it. Your account settings will be returned to the default settings. Please confirm that you want to reset your account settings before making these changes.',
  restore: {
    message: 'Restore',
