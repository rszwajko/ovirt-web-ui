...
export const SAVE_OPTIONS_ON_BACKEND = 'SAVE_OPTIONS_ON_BACKEND'
...
export const SET_OPTION_TO_VMS = 'SET_OPTION_TO_VMS'
export const SET_OPTIONS_SAVE_RESULTS = 'SET_OPTIONS_SAVE_RESULTS'
